...
import { Container, LinearProgress, TableContainer, TextField, ThemeProvider, Typography, createTheme, Table, TableHead, TableRow, TableCell, TableBody, makeStyles } from '@material-ui/core';
...
export default function Coinstable() {
  ...
  // Filtering Coins based on search field.
  const handleSearch = () =>{
  ...
  return (
    <ThemeProvider theme={darkTheme}>
        <Container style={{textAlign: "center"}}>
            ...
            {/* onChange is if page is selected, it will render than page and scroll to top. */}
